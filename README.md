# Overview
These scripts are used to communicate with a Thalmic Myo, to collect its raw 
EMG data. The data can be viewed using pygame, or printed in terminal or to a txt file.

These scripts are cloned and modified from github user 'dzhu's 'myo-raw' repository.
The repository can be found online at 'https://github.com/dzhu/myo-raw'.
...
Acknowledgements: 
- dzhu original 'myo-raw' scripts.
  (https://github.com/dzhu/myo-raw)
- Jeff Rowberg's example bglib implementations
...
Note that the default download for windows pygame is 32 bit. If you are using a 64 bit version
of python, you will have to find and download the 64 bit version of pygame.
